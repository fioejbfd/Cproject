...
//ex) 자동차, 냉장고, 스마트 워치 등의 기능 담당 하드웨어를 제어하는 소프트웨어에 대한 제작
...
int main()
{
	...
	*ptr_value = 7;
	...
	//pptr_value는 ptr_value 변수의 주소를 가리키고 있습니다.(이중포인터)
